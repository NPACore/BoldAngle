...
for bold in \
	...
	../Data/preproc/bids-*/xcpd-ver-0.12.0_prep-25.2.3_type-nifti_fd-0.3_bp-yes/sub-*/func/sub-*_space-MNI152NLin2009cAsym_desc-denoisedSmoothed_bold.nii.gz\
	; do
  ...
  [[ $bold =~ xcpd ]] && xcpd=_xcpd || xcpd=""
  out=../Data/tsnr/$acqver/$(basename $bold| sed "s/_space.*/${xcpd}_tsnr.nii.gz/")
  ...
  ! test -r $mask && echo "WARNING no $mask" && mask=
  test -r $out || \
