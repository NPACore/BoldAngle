AFNI_TIME_LOCK=YES \
afni \
   -DAFNI_crosshairgap=0 \
   -com 'OPEN_WINDOW A.axialimage mont=1x2:50' -com 'SWITCH_UNDERLAY epi.nii.gz'  \
   -com 'OPEN_WINDOW B.axialimage mont=1x2:50' -com 'SWITCH_UNDERLAY B.resliced.nii.gz'\
   -com 'OPEN_WINDOW C.axialimage mont=1x2:50' -com 'SWITCH_UNDERLAY C.epi_undistorted_mask.nii.gz'\
   ...
   -com 'SWITCH_OVERLAY D.epi_undistorted_masked.nii.gz'  \
  wf/human-largefov/sub-1/
