...
./angle_at_max.py --nosd \
   -i wf/human-largefov/sub-2/epi_undistorted_masked.nii.gz \
   -m wf/human-largefov/sub-2/mean_epi_brain.nii.gz \
   -o wf/human-largefov/sub-2/angles_at_max_nosd.nii.gz
