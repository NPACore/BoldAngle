...
roi_vec <- data.frame(roi=readNifti('./Olfactory/atlas-AonPirFTTubV4_res-func.nii.gz') |> as.vector()) |>
  mutate(i=1:n()) |>
  filter(roi>0) |>
...
#+begin_src R :session :results graphics file :file Figures/orgmode/maxangle/b0_by_.png :session :height 800
...
#+RESULTS:
[[file:Figures/orgmode/maxangle/b0_by_.png]]
