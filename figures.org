...
images_to_cor <- list(
  ...
  msa_1_3d = 'AngleCompare/maxangle_mni/sub-1e3d_a10_space-MNI_maxangle.nii.gz',
  ...
  b03d_1='AngleCompare/maxangle_mni/sub-1iso3d_space-MNI152NLin2009cAsym_fmapDirect.nii.gz',
  ...
  tsnr_1_3d = 'AngleCompare/maxangle_mni/3depi2x2x2/sub-1iso3d_angleatmax-tsnr.nii.gz',
  ...
  sd_1_3d='AngleCompare/maxangle_mni/sub-1iso3d_select-n40n33n13p13p20_angleatmax-sd.nii.gz')
...
#+RESULTS:
|           |  msa_1 |  msa_2 | msa_1_3d |   b0_1 |   b0_2 | b03d_1 | tsnr_1 | tsnr_2 | tsnr_1_3d |   sd_1 |   sd_2 | sd_1_3d |
|-----------+--------+--------+----------+--------+--------+--------+--------+--------+-----------+--------+--------+---------|
| msa_1     |      1 |  0.529 |    0.411 |   -0.3 | -0.286 | -0.272 |  0.158 |   0.09 |    -0.099 |  0.039 |  0.029 |  -0.026 |
| msa_2     |  0.529 |      1 |    0.385 |  -0.33 | -0.314 | -0.308 |  0.155 |   0.14 |    -0.087 |  0.059 |  0.032 |  -0.018 |
| msa_1_3d  |  0.411 |  0.385 |        1 | -0.419 | -0.379 | -0.242 |  0.153 |  0.131 |     -0.19 |  0.071 |   0.09 |  -0.103 |
| b0_1      |   -0.3 |  -0.33 |   -0.419 |      1 |  0.829 |  0.859 | -0.192 |  -0.18 |    -0.014 | -0.097 | -0.122 |    0.04 |
| b0_2      | -0.286 | -0.314 |   -0.379 |  0.829 |      1 |  0.672 | -0.129 | -0.114 |     0.099 | -0.052 | -0.025 |   0.018 |
| b03d_1    | -0.272 | -0.308 |   -0.242 |  0.859 |  0.672 |      1 | -0.163 | -0.148 |    -0.116 | -0.054 |  -0.08 |  -0.044 |
| tsnr_1    |  0.158 |  0.155 |    0.153 | -0.192 | -0.129 | -0.163 |      1 |  0.163 |     0.073 |  0.287 |  0.138 |  -0.024 |
| tsnr_2    |   0.09 |   0.14 |    0.131 |  -0.18 | -0.114 | -0.148 |  0.163 |      1 |     0.039 |  0.096 |  0.303 |   0.019 |
| tsnr_1_3d | -0.099 | -0.087 |    -0.19 | -0.014 |  0.099 | -0.116 |  0.073 |  0.039 |         1 |  0.024 |  0.041 |  -0.145 |
| sd_1      |  0.039 |  0.059 |    0.071 | -0.097 | -0.052 | -0.054 |  0.287 |  0.096 |     0.024 |      1 |  0.171 |  -0.066 |
| sd_2      |  0.029 |  0.032 |     0.09 | -0.122 | -0.025 |  -0.08 |  0.138 |  0.303 |     0.041 |  0.171 |      1 |  -0.033 |
| sd_1_3d   | -0.026 | -0.018 |   -0.103 |   0.04 |  0.018 | -0.044 | -0.024 |  0.019 |    -0.145 | -0.066 | -0.033 |       1 |
