...
| msa_3d1  |  0.411 |  0.385 |       1 | -0.419 | -0.379 | -0.242 |  0.153 |  0.131 |    -0.19 |  0.071 |   0.09 | -0.103 |
...
| b0_3d1   | -0.272 | -0.308 |  -0.242 |  0.859 |  0.672 |      1 | -0.163 | -0.148 |   -0.116 | -0.054 |  -0.08 | -0.044 |
...
| tsnr_3d1 | -0.099 | -0.087 |   -0.19 | -0.014 |  0.099 | -0.116 |  0.073 |  0.039 |        1 |  0.024 |  0.041 | -0.145 |
...
| sd_3d1   | -0.026 | -0.018 |  -0.103 |   0.04 |  0.018 | -0.044 | -0.024 |  0.019 |   -0.145 | -0.066 | -0.033 |      1 |
...
#+begin_src R :session
mt_nii <- images_to_cor[c('msa_1','tsnr_1')] |> lapply( \(f) readNifti(f)|>round())
par(mfrow=c(1,2))
